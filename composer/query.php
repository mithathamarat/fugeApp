        ...
        <nav >
          <ul class="nav nav-pills pull-right">
           ...
           <li class="dropdown active" >
              ...
              <li role="presentation" ><a href="tableSelect">Insert+Update+Delete</a></li>
            <li role="presentation" class="active"><a href="Query">Query</a></li>
...
@$newsesion .=$_SESSION[''.$tab[0].'que'];
	  
echo '<label class="radio-inline">
  <input type="radio" name="field" id="radio" value="'.$tab[0].'"> '.$tab[0].'
</label>';
}?>
  </div>
  ...
  <div class="text-center"><i class="fa fa-files-o" aria-hidden="true"></i> Generates Query codes and files</div>    
 ...
 <div class="text-center" id="folder" style="padding-top:10px; display:none; "><a    onclick="opi()" class="btn btn-default"><i class="fa fa-folder-open" aria-hidden="true"></i> Open project folder</a> </div>
  ...
  <?php if(empty($newsesion)){}else{echo $newsesion;} ?>   
...
<script src="scrips/query.js"></script>
