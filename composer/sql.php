...
<div class="container">
      <div class="header clearfix">
        ...
        <h3 class="text-muted"><i class="fa fa-cube" aria-hidden="true"></i> <?= $_SESSION['project'] ?> db selection</h3>
      </div>

      <div class="upform">
      <span id="error"></span>
   <form  id="project-table">
<div class="form-group">
    
    <input type="text" class="form-control"  name="db" placeholder="Db Name">
  </div>
  
  <button type="submit" class="btn btn-default" id="submit" name="btn-name">Apply</button>
</form>
      </div>
...
<script src="scrips/db.js"></script>
